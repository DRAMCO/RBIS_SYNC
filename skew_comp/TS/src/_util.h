...
#define csvprint(a) (Serial.print(a))
#define csvprintln(a) (Serial.println(a))

/* #define csvprint(a) // to disable printing csv data
#define csvprintln(a)  // to disable printing csv data */

#define Sprintln(a) // to disable printing
#define Sprint(a) // to disable printing


/* #define Sprintln(a) (Serial.println(a)) // to enable printing
#define Sprint(a) (Serial.print(a)) // to enable printing */

#define maxreferences 100 //max amount of saved references
#define maxMasterref  100  //max amount of received references
...
const uint8_t beaconPacket[109] = {
  ...
  /* 10 - 15 */ 0x01, 0x02, 0x03, 0x04, 0x05, 0x03, // Source
  /* 16 - 21 */ 0x01, 0x02, 0x03, 0x04, 0x05, 0x03, // Source
...
int calculateOffsets(struct referencepoint Myreferencepoints[], struct referencepoint Mastersreferencepoints[], int offsets[], uint64_t time[]);
